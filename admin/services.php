    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="form-group">
        <label>Type</label><input  class="form-control" name="type" maxlength="500">
        </div>
        <div class="form-group">
        <label>Description</label><textarea type="text" class="form-control" name="des"></textarea>
        </div>
        <div class="form-group">
